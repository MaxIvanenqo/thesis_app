...
int PosixDirectives() {
    ...
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R8:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_R8)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R8:PropertyInfo:signedness=$%s$\n", ((REG_R8>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R8:PropertyInfo:value=%lX\n", ((unsigned long)REG_R8));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R9:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_R9)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R9:PropertyInfo:signedness=$%s$\n", ((REG_R9>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R9:PropertyInfo:value=%lX\n", ((unsigned long)REG_R9));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R10:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_R10)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R10:PropertyInfo:signedness=$%s$\n", ((REG_R10>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R10:PropertyInfo:value=%lX\n", ((unsigned long)REG_R10));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R11:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_R11)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R11:PropertyInfo:signedness=$%s$\n", ((REG_R11>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R11:PropertyInfo:value=%lX\n", ((unsigned long)REG_R11));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R12:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_R12)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R12:PropertyInfo:signedness=$%s$\n", ((REG_R12>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R12:PropertyInfo:value=%lX\n", ((unsigned long)REG_R12));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R13:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_R13)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R13:PropertyInfo:signedness=$%s$\n", ((REG_R13>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R13:PropertyInfo:value=%lX\n", ((unsigned long)REG_R13));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R14:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_R14)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R14:PropertyInfo:signedness=$%s$\n", ((REG_R14>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R14:PropertyInfo:value=%lX\n", ((unsigned long)REG_R14));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R15:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_R15)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R15:PropertyInfo:signedness=$%s$\n", ((REG_R15>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_R15:PropertyInfo:value=%lX\n", ((unsigned long)REG_R15));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RDI:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_RDI)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RDI:PropertyInfo:signedness=$%s$\n", ((REG_RDI>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RDI:PropertyInfo:value=%lX\n", ((unsigned long)REG_RDI));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RSI:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_RSI)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RSI:PropertyInfo:signedness=$%s$\n", ((REG_RSI>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RSI:PropertyInfo:value=%lX\n", ((unsigned long)REG_RSI));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RBP:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_RBP)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RBP:PropertyInfo:signedness=$%s$\n", ((REG_RBP>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RBP:PropertyInfo:value=%lX\n", ((unsigned long)REG_RBP));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RBX:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_RBX)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RBX:PropertyInfo:signedness=$%s$\n", ((REG_RBX>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RBX:PropertyInfo:value=%lX\n", ((unsigned long)REG_RBX));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RDX:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_RDX)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RDX:PropertyInfo:signedness=$%s$\n", ((REG_RDX>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RDX:PropertyInfo:value=%lX\n", ((unsigned long)REG_RDX));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RAX:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_RAX)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RAX:PropertyInfo:signedness=$%s$\n", ((REG_RAX>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RAX:PropertyInfo:value=%lX\n", ((unsigned long)REG_RAX));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RCX:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_RCX)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RCX:PropertyInfo:signedness=$%s$\n", ((REG_RCX>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RCX:PropertyInfo:value=%lX\n", ((unsigned long)REG_RCX));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RSP:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_RSP)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RSP:PropertyInfo:signedness=$%s$\n", ((REG_RSP>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RSP:PropertyInfo:value=%lX\n", ((unsigned long)REG_RSP));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RIP:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_RIP)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RIP:PropertyInfo:signedness=$%s$\n", ((REG_RIP>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_RIP:PropertyInfo:value=%lX\n", ((unsigned long)REG_RIP));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_EFL:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_EFL)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_EFL:PropertyInfo:signedness=$%s$\n", ((REG_EFL>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_EFL:PropertyInfo:value=%lX\n", ((unsigned long)REG_EFL));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_CSGSFS:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_CSGSFS)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_CSGSFS:PropertyInfo:signedness=$%s$\n", ((REG_CSGSFS>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_CSGSFS:PropertyInfo:value=%lX\n", ((unsigned long)REG_CSGSFS));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_ERR:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_ERR)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_ERR:PropertyInfo:signedness=$%s$\n", ((REG_ERR>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_ERR:PropertyInfo:value=%lX\n", ((unsigned long)REG_ERR));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_TRAPNO:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_TRAPNO)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_TRAPNO:PropertyInfo:signedness=$%s$\n", ((REG_TRAPNO>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_TRAPNO:PropertyInfo:value=%lX\n", ((unsigned long)REG_TRAPNO));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_OLDMASK:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_OLDMASK)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_OLDMASK:PropertyInfo:signedness=$%s$\n", ((REG_OLDMASK>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_OLDMASK:PropertyInfo:value=%lX\n", ((unsigned long)REG_OLDMASK));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_CR2:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(REG_CR2)));
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_CR2:PropertyInfo:signedness=$%s$\n", ((REG_CR2>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:EnumConstantInfo:REG_CR2:PropertyInfo:value=%lX\n", ((unsigned long)REG_CR2));
